function CalorieCalculatorTeaser() {
    const inputs = [
        ...
        { icon: "venus-mars", label: "Jenis Kelamin" },
        { icon: "activity", label: "Aktivitas Harian" }
    ];
    
    const methods = [
        { icon: "calculator", label: "BMR", desc: "Kalori dasar tubuh" },
        { icon: "activity", label: "TDEE", desc: "Total kalori harian" }
    ];
    ...
    return React.createElement(
        ...
        React.createElement(
            "div",
            { className: "container mx-auto px-6 max-w-4xl" }, // Mengurangi max-width untuk tampilan lebih rapi
            React.createElement(
                "div",
                { className: "text-center mb-12" },
                React.createElement("h2", { className: "text-4xl font-bold text-gray-800 mb-4" }, "Kalkulator Kalori"),
            ...
            // Container utama tanpa kolom gambar
            React.createElement(
                "div",
                { className: "w-full" }, // Full width tanpa flex layout
                ...
                React.createElement(
                    ...
                    React.createElement(
                        "div",
                        { className: "grid grid-cols-2 md:grid-cols-3 lg:grid-cols-5 gap-4" }, // 5 kolom di desktop
                        inputs.map((inp, i) =>
                            React.createElement(
                                "div",
                                { 
                ...
                React.createElement(
                    ...
                    React.createElement(
                        "div",
                        { className: "grid grid-cols-1 md:grid-cols-2 gap-4" }, // Grid 2 kolom
                        methods.map((met, i) =>
                            React.createElement(
                                "div",
                                { 
                                ...
                                React.createElement(
                                    "div",
                                    { className: "flex items-center gap-4" }, // Align items center
